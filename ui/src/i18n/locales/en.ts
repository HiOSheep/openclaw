  ...
  chat: {
    ...
    backgroundTasks: {
      ...
      subagentActivity: {
        ...
        waitingDescription: "Waiting — paused for a dependency or external event.",
        unknownDescription: "Activity unknown — current execution details are unavailable.",
        executionFinishedDescription: "Execution finished — task settlement is still pending.",
        resultReadyDescription: "Result ready — waiting for delivery to the parent.",
        deliveredDescription: "Delivered — the result reached the parent.",
        deliveryFailedDescription: "Delivery failed — the result could not reach the parent.",
